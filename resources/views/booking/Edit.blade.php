                    ...
                    <form method="post" action="{{ url('admin/booking/' . $booking->id) }}">
                        ...
                        <table class="table table-bordered">
                            <tr>
                                ...
                                <td><input value="{{ $booking->guest_name }}" name="full_name" type="text"
                                        class="form-control" /></td>
                            </tr>
                            <tr>
                                <th>Email <span class="text-danger">*</span></th>
                                <td><input value="{{ $booking->guest_email }}" name="email" type="email"
                                        class="form-control" /></td>
                            </tr>
                            <tr>
                                <th>Check-in Date:<span class="text-danger">*</span></th>
                                <td><input value="{{ $booking->check_in_date }}" name="check_in_date" type="date"
                                        class="form-control" /></td>
                            </tr>
                            <tr>
                                <th>Check-out Date:<span class="text-danger">*</span></th>
                                <td><input value="{{ $booking->check_out_date }}" name="check_out_date" type="date"
                                        class="form-control" /></td>
                            </tr>
                            ...
                            <tr>
                                    ...
                                    <td>
                                        <select name="room_type_id" class="form-control">
                                            @foreach($roomTypes as $roomType)
                                                <option value="{{ $roomType->id }}" {{ $booking->room_type_id == $roomType->id ? 'selected' : '' }}>
                                                    {{ $roomType->title }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <td><input value="{{ $booking->num_guests }}" name="num_guests" type="number"
                                        class="form-control" /></td>
                            </tr>
                            <tr>
                                <th>Total Price:<span class="text-danger">*</span></th>
                                <td><input value="{{ $booking->total_price }}" name="total_price" type="text"
                                        class="form-control" /></td>
                            </tr>
                            <tr>
                                <th>Booking Status:<span class="text-danger">*</span></th>
                                <td><input value="{{ $booking->booking_status }}" name="booking_status" type="text"
                                        class="form-control" /></td>
                            </tr>
